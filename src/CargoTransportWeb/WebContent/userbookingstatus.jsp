...
<div class="container-xxl py-5">
    <div class="container py-5">
        <p style="text-align: center; font-size: 50px;">Booking Status </p>
        <div style="align-items: center; padding-left:5cm; padding-right: 5cm;" >
            <div class="bg-light text-center p-5 wow fadeIn" data-wow-delay="0.5s">
			  	...
			  	try
			  	{
			  		...
			  		PreparedStatement ps = con.prepareStatement("select * from booking_tbl where user_email = ? ");
			  ...
			  %>
				  			 <tr>
							    ...
							    <td><a href="approve.jsp?booking_id=<%=rs.getString("booking_id")%>"><%=rs.getString("booking_status")%></a></td>
							 	<td><a href="viewBill.jsp?booking_id=<%=rs.getString("booking_id")%>">View Bill</a></td>
							  </tr>
